...
const ThirdSection = () => {
  ...
  return (
   ...
   <motion.h2
           className="flex justify-center items-center max-auto text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-[#010205] font-semibold leading-[100%] tracking-[-1.44px] py-10"
           initial={{ opacity: 0, y: 40 }}
           whileInView={{ opacity: 1, y: 0 }}
           viewport={{ once: true, amount: 0.3 }}
           transition={{ duration: 0.5, ease: "easeOut" }}
         >
           We served over 300+ clients across the world 
         </motion.h2>
